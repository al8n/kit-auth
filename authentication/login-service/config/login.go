...
func (a *Login) BindFlags(fs *bootflag.FlagSet)  {
	fs.StringVar(&a.Name, "auth-name", "Login Service", "the service name")
...
func (a *Login) parseSecret() (err error) {
